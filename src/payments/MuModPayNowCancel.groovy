...
/**
 * Created by kmahas on 10/25/2017.
 *
 * NOVA POS GC hotel - Item search/Multi Module-FreeCancellation-outside-verify cancel for free cancellation item
 *
 */
class MuModPayNowCancel extends PaymentSpec {
    //Client Login
    @Shared
    ...
    @Shared
    PaymentsTestData paymentsData = new PaymentsTestData("MuModPayNowCancelTest", "payments", paymentDetails)
    @Shared
    PaymentsTestResultData resultData = new PaymentsTestResultData("MuModPayNowCancelTest", paymentsData)
    ...
    def "TC00: Multi Module Pay Now Pay Later "() {
        ...
        Unavailableblock(paymentsData,resultData,2,0,1)
    }
    ...
    def "TC25: Verify Cancel Item Actual & Expected Results"() {
        given: "user is on itinerary page"
        verifycancelAllBookings(paymentsData,resultData)
    }
    def "TC26: Verify Unavailable and Cancelled Items Actual & Expected Results"() {
        given: "user is on itinerary page"
