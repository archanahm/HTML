 ...
 */
class CreditQuickSearchTest extends ItinerarySearchBaseSpec{
    ...
    @Shared
    ItinerarySearchTestData itinerarySearchData = new ItinerarySearchTestData("6101", "itinerarySearch", itinerarySearch)
    @Shared
    ItinerarySearchTestResultData resultData = new ItinerarySearchTestResultData("6101", itinerarySearchData)
