...
/**
 * Created by kmahas on 11/29/2017.
 *
 * * 62.05
 *
 * Payment - Itinerary Search - Quick - Itinerary ID + Booking ID + traveller Name - View own bookings
 *
 */
class PaymentItinryQuickSearchTest extends ItinerarySearchBaseSpec{

    //Client Login
    @Shared
    ClientData clientData = new ClientData("client85502")
    @Shared
    public static Map<String, ItinerarySearchTestResultData> resultMap = [:]
    @Shared
    ItinerarySearchTestData itinerarySearchData = new ItinerarySearchTestData("6205", "itinerarySearch", itinerarySearch)
    @Shared
    ItinerarySearchTestResultData resultData = new ItinerarySearchTestResultData("6205", itinerarySearchData)


    def "TC00: Payment - Itinerary Search - Quick - Itinerary ID + Booking ID + traveller Name - View own bookings "() {
        ...
        BookingIDPartialLegacyAndNovabookings(itinerarySearchData.input.bookingIDPartialLegacyAndNovaBooking,itinerarySearchData,resultData)
        TravlrNamePartalLegacyAndNovabkng(itinerarySearchData.input.bookingIDPartlLegacyAndNovaBooking,itinerarySearchData,resultData)
