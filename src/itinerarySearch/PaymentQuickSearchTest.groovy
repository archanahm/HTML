 ...
 *
 * 62.01
 * Payment - Itinerary Search - Quick - Itinerary ID + Booking ID + traveller Name - View all bookings
 */
class PaymentQuickSearchTest extends ItinerarySearchBaseSpec{
    ...
    @Shared
    ItinerarySearchTestData itinerarySearchData = new ItinerarySearchTestData("6201", "itinerarySearch", itinerarySearch)
    @Shared
    ItinerarySearchTestResultData resultData = new ItinerarySearchTestResultData("6201", itinerarySearchData)


    def "TC00: Payment - Itinerary Search - Quick - Itinerary ID + Booking ID + traveller Name - View all bookings "() {
