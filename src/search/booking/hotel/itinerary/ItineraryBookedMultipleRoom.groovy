...
class ItineraryBookedMultipleRoom extends ItineraryHotelItemBaseSpec{
	@Shared
	...
	@Shared
	HotelSearchData hotelData = new HotelSearchData("Lincoln-SITUJ19XMLAuto-MultiRoom")
	@Shared
	HotelTransferTestResultData resultData = new HotelTransferTestResultData("Lincoln-SITUJ19XMLAuto-MultiRoom",hotelData)
