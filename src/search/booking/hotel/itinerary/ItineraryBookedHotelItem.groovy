...
class ItineraryBookedHotelItem extends ItineraryHotelItemBaseSpec{
	@Shared
	...
	@Shared
	HotelSearchData hotelData = new HotelSearchData("Lincoln-SITUJ19XMLAuto")
	@Shared
	HotelTransferTestResultData resultData = new HotelTransferTestResultData("Lincoln-SITUJ19XMLAuto",hotelData)
