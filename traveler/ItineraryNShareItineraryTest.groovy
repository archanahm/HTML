 ...
 */
class ItineraryNShareItineraryTest{
    @Shared
    ...
    def "TC00: NOVA POS - Share Itinerary / Traveller View - HH - single room - booked / non-booked"() {
        ...
        bookHotelItem(0)
        bookHotelItem(1)
        storeItemsInItinerary(resultData)
    ...
    def "TC16: VerifyOnRequestHotelItemAgainstItinerary"(){
        given: "User is logged in and present on Share Itinerary Page"
        verifyShareItineraryOnRequestItem(hotelSearchData, resultData)
    }
    def "TC17: Verify ShareItiBookingTotalRate"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifyShareItiBookingTotalRate(hotelSearchData, resultData)
    }
    def "TC18: Verify ShareItinerary Section3"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifyShareItinerarySection3(hotelSearchData, resultData)
    }
    def "TC19: Verify Section3 ToggleButton1"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifySection3ToggleButton1(hotelSearchData, resultData)
    }
    def "TC20: Verify Section3 ToggleButton2"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifySection3ToggleButton2(hotelSearchData, resultData)
    }
    def "TC21: Verify Section3 ToggleButton3"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifySection3ToggleButton3(hotelSearchData, resultData)
    }
    def "TC22: Verify NonBookedItemCard Against Itinerary"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifyNonBookedItemCardAgainstItinerary(hotelSearchData, resultData)
    }
    def "TC23: Verify BookedAndNonBooked TotalRate"(){
        given: "User is logged in and present on Share Itinerary Page"
        VerifyBNBTotalRate(hotelSearchData, resultData)
    }
    def "TC24: Verify ShareItinerary Overlay"(){
